...
//	
//	Student(String name, int classNo, int studentNo, int kor, int math, int eng) {
//		this.name = name;
...
//		return this.name + "\t" + this.classNo + "\t" + this.studentNo + "\t" + this.kor + "\t" + this.math  + "\t" + this.eng  + "\t" + this.total;
// 	}
//
//       /*
//
